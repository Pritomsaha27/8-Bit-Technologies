...
function Values() {
  ...
  return (
    ...
    <div className='container mx-auto px-32'>
     ...
     data-aos-duration="1000" className='bg-gray-100 mt-10 p-10'>
       <img className='I' src="https://d1brrfe9oh6qhi.cloudfront.net/abticon-1.png" alt="" />
     ...
     data-aos-duration="800" className='w-16 ' src={values.image} alt="" />
              <div data-aos="fade-up"
     data-aos-duration="900" className='font-semibold mt-4'>{values.heading}</div>
              <div data-aos="fade-up"
     data-aos-duration="1000" className=' mt-2'>{values.description}</div>
            </div>
          ))}
        </div>
        <p className='text-center mt-16 text-xl px-10 '>
