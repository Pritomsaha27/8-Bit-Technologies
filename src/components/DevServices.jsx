  ...
  return (
    <>
      ...
      <div className="flex container gap-6 mx-auto px-32 h-auto my-12">
        ...
        <div className="w-1/2 px-6 rounded-xl">
          ...
          <button className=" bg-sky-500 rounded w-48 btn h-16 mt-16 text-white text-sm font-semibold">
          <Link to="/contact">CONTACT US NOW</Link> <FaArrowRightLong />
          </button>
        </div>
      </div>
    </>
