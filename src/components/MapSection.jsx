...
function MapSection() {
  ...
  return (
    <>
      ...
      <div className="container mt-10 flex flex-col xl:px-32  lg:flex-row gap-10 mx-auto px-3">
        <div className="overflow-hidden rounded-lg h-96   flex-1" style={{ flexBasis: "70%" }}>
          <iframe
            width="100%"
            height="100%"
            title="map"
        ...
        <p className="text-sm text-gray-800 flex-1 mt-4 lg:mt-0" >
