export const DATA = [
  {
    ...
    landingtext: " 8-Bit Technologies has developed a number of SaaS products on the AWS platform.We have also developed an IoT cloud infrastructure that  supports about a hundred thousand smart homes. We have built a virtual meeting platform that can scale up to host 1000s of attendees  and multiple events. We have helped clients save costs and improve application performance by migrating them to AWS.",
  ...
  },
  {
    ...
    landingtext: "Node.js is a scalable platform that enables engineers to create fast, asynchronous systems. At 8-Bit , we create high-performance, flexible, and lightweight apps using the Node.js development framework. Our 9+ years of experience  have made us experts in Node.js software development.One of our strong points is the use of frameworks like the MERN stack, which uses React on the front end and MongoDB, Express, and Node on the backend. We have a solid team of developers in this tech stack and are confident of making high-quality products that can scale up to handle a large amount of traffic",
  ...
  },
  {
    ...
    landingtext: "With 8-Bit  Technologies' remarkable web application services and solutions develop a top-notch web application. Our skilled React developers, will assist you to set up a faster, excellent user experience, and high-quality website front-end.",
